...
CREATE TABLE "new_Invoice" (
    ...
    CONSTRAINT "Invoice_userID_userName_userEmail_userAddress1_userAddress2_fkey" FOREIGN KEY ("userID", "userName", "userEmail", "userAddress1", "userAddress2") REFERENCES "User" ("id", "name", "email", "address1", "address2") ON DELETE RESTRICT ON UPDATE CASCADE,
